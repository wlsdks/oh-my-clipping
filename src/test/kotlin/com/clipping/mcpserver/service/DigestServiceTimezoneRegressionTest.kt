...
class DigestServiceTimezoneRegressionTest {
    ...
    private val digestModuleSources = listOf(
        "src/main/kotlin/com/clipping/mcpserver/service/digest/DigestService.kt",
        "src/main/kotlin/com/clipping/mcpserver/service/digest/DigestRenderer.kt",
        "src/main/kotlin/com/clipping/mcpserver/service/digest/DigestSelectionService.kt",
    )
