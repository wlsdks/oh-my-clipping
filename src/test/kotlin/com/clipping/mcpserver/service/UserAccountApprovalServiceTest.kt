...
class UserAccountApprovalServiceTest {
    ...
    inner class `updateSelfProfile — V129 FK` {
        ...
        private val oldDepartment = com.clipping.mcpserver.model.Department(
            id = "dept-old",
            name = "영업팀",
            nameNormalized = "영업팀"
        )
        private val newDepartment = com.clipping.mcpserver.model.Department(
            id = "dept-new",
            name = "마케팅팀",
            nameNormalized = "마케팅팀"
        )
        private val newTeam = com.clipping.mcpserver.model.Team(
            id = "team-new",
        ...
        fun `null 필드는 기존 FK 값을 유지한다`() {
            ...
            every { departmentTreeService.resolveUserAssignment("dept-new", "team-existing") } returns
                (newDepartment to com.clipping.mcpserver.model.Team(
                    id = "team-existing",
                    departmentId = "dept-new",
                    name = "existing",
