...
import com.clipping.mcpserver.store.PersonaVersionStore
...
class AdminPersonaServiceTest {
    ...
    inner class `삭제 정책` {
        ...
        fun `구독이 있는 페르소나는 삭제할 수 없다`() {
            ...
            shouldThrow<com.clipping.mcpserver.error.ConflictException> {
    ...
    inner class `낙관적 잠금` {
        ...
        fun `store가 null을 반환하면 StaleEditInfo를 담은 ConflictException을 던진다`() {
            ...
            ex.staleEditInfo shouldBe com.clipping.mcpserver.error.StaleEditInfo(
                code = "STALE_EDIT",
    ...
    inner class `setActive 테스트` {
        ...
        fun `존재하지 않는 페르소나 ID는 NotFoundException`() {
            ...
            shouldThrow<com.clipping.mcpserver.error.NotFoundException> {
