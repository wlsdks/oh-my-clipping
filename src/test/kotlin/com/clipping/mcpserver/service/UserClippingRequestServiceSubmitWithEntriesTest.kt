...
class UserClippingRequestServiceSubmitWithEntriesTest {
    ...
    inner class `submitRequestWithEntries` {
        ...
        fun `위자드가 고른 발송 프리셋·요일·시각이 user_delivery_schedules 로 upsert 된다`() {
            ...
            val captured = io.mockk.slot<com.clipping.mcpserver.model.UserDeliverySchedule>()
            ...
            captured.captured.preset shouldBe com.clipping.mcpserver.model.DeliveryPreset.EVERYDAY
        ...
        fun `스케줄 정보가 누락되면 기본값 WEEKDAYS 9시로 upsert 된다`() {
            ...
            captured.captured.preset shouldBe com.clipping.mcpserver.model.DeliveryPreset.WEEKDAYS
