...
import com.clipping.mcpserver.service.digest.DigestOpsNotifier
...
class SlackDigestWorkerTest {
    ...
    private val clippingService = mockk<com.clipping.mcpserver.service.port.DigestDeliveryWorkflowPort>()
    ...
    inner class `Slack rate limiter throttling (regression for dead-code bug)` {
        ...
        fun `여러 대상이 있을 때 발송 사이마다 rate limiter가 호출된다`() {
            ...
            val rateLimiter = mockk<com.clipping.mcpserver.resilience.TokenBucketRateLimiter>(relaxed = true)
            ...
            val adminUser = mockk<com.clipping.mcpserver.model.AdminUser>()
