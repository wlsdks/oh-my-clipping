...
class ReportSettingsServiceTest {
    ...
    private val auditLogStore = mockk<com.clipping.mcpserver.store.AuditLogStore>(relaxed = true)
    ...
    inner class `설정 업데이트` {
        ...
        fun `유효하지 않은 요일이면 예외를 던진다`() {
            assertThrows<com.clipping.mcpserver.error.InvalidInputException> {
