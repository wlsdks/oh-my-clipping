...
import com.clipping.mcpserver.model.KeywordEntity
import com.clipping.mcpserver.store.BatchSummaryStore
import com.clipping.mcpserver.store.KeywordEntityStore
...
class KeywordEntityServiceTest {
    ...
    inner class `키워드 수동 분류` {
        ...
        fun `유효하지 않은 카테고리는 예외를 발생시킨다`() {
            val exception = assertThrows<com.clipping.mcpserver.error.InvalidInputException> {
