...
import com.ohmyclipping.observability.SchedulerErrorNotifier
import com.ohmyclipping.observability.TokenHealthTracker
import com.ohmyclipping.observability.TokenStatus
...
import com.ohmyclipping.support.GeminiErrorCategory
import com.ohmyclipping.support.GeminiErrorClassifier
...
class ItemSummarizationService(
    ...
    internal fun isTransient(e: Exception): Boolean {
        ...
        if (e is com.ohmyclipping.ai.GeminiTruncationException) return false
