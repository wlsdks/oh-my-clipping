...
class SlackDigestWorker(
    ...
    private val schedulerErrorNotifier: com.ohmyclipping.observability.SchedulerErrorNotifier?,
            ...
            for ((index, reservedTarget) in reservedTargets.withIndex()) {
                ...
                when (result) {
                    ...
                    DeliveryOutcome.FAILED -> {
                        digestFailures.add(
                            com.ohmyclipping.service.port.DigestFailure(
                                categoryId = category.id,
    ...
    private fun deliverPreparedDigestWithResult(
        ...
        preparedDigest: com.ohmyclipping.service.dto.clipping.DigestResult
    ): DeliveryOutcome {
        return try {
    ...
    private fun mergeAbandonedItems(
        categoryId: String,
        channelId: String,
        current: com.ohmyclipping.service.dto.clipping.DigestResult
    ): Pair<com.ohmyclipping.service.dto.clipping.DigestResult, List<String>> {
