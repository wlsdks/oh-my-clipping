...
import com.ohmyclipping.service.dto.user.EntryError
...
import com.ohmyclipping.service.dto.user.UserRequestDeliveryStatusView
...
import com.ohmyclipping.service.dto.admin.ApprovalResult
import com.ohmyclipping.service.tx.publishAfterCommit
...
class UserClippingRequestService(
    ...
    fun approveRequestWithEntries(
        ...
        val category = categoryStore.save(
            com.ohmyclipping.model.Category(
                id = "",
                name = normalizedName,
