...
import com.ohmyclipping.admin.dto.RuntimeSettingAuditResponse
import com.ohmyclipping.admin.dto.RuntimeSettingsResponse
import com.ohmyclipping.admin.dto.SlackBlockKitPreviewRequest
import com.ohmyclipping.admin.dto.SlackBlockKitPreviewResponse
import com.ohmyclipping.admin.dto.SlackBlockKitTestSendRequest
import com.ohmyclipping.admin.dto.SlackBlockKitTestSendResponse
...
import com.ohmyclipping.admin.dto.SlackSocketConnectionVerifyRequest
import com.ohmyclipping.admin.dto.SlackSocketConnectionVerifyResponse
import com.ohmyclipping.admin.dto.SlackSocketModeStatusResponse
import com.ohmyclipping.admin.dto.UpdateRuntimeSettingsRequest
...
import com.ohmyclipping.service.SlackSocketModeService
        ...
        return runtimeSettingService.update(
            RuntimeSettingService.RuntimeSettingsUpdate(
                ...
                opsNotificationProfile = request.opsNotificationProfile?.let {
                    runCatching { com.ohmyclipping.service.OpsNotificationProfile.valueOf(it) }.getOrNull()
                },
