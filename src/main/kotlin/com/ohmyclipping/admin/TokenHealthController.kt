...
import com.ohmyclipping.admin.dto.TokenHealthResponse
...
class TokenHealthController(
    ...
    fun getTokenHealth(): TokenHealthResponse {
        ...
        return TokenHealthResponse(
            ...
            ok = slack == com.ohmyclipping.observability.TokenStatus.OK &&
                gemini == com.ohmyclipping.observability.TokenStatus.OK
        )
    }
}
