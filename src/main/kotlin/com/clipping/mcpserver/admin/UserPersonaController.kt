...
import com.clipping.mcpserver.service.UserOwnedPersonaService
import com.clipping.mcpserver.service.dto.UserOwnedPersonaView
...
class UserPersonaController(private val userOwnedPersonaService: UserOwnedPersonaService) {
    ...
    private fun com.clipping.mcpserver.model.Persona.toResponse() = PersonaResponse(
