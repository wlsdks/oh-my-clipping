...
import com.clipping.mcpserver.service.dto.PipelineStartCommand
    ...
    fun startExecution(command: PipelineStartCommand): String {
        ...
        if (category != null) {
            ...
            if (approvedSources.isEmpty()) {
                throw com.clipping.mcpserver.error.InvalidInputException(
        ...
        if (runningCount > 0) {
            throw com.clipping.mcpserver.error.ConflictException(
