...
class PipelineAsyncWorker(
    ...
    private fun runPipeline(
        ...
        ralphLoopMaxIterations: Int?,
        ralphLoopStopPhrase: String?
    ): com.clipping.mcpserver.service.dto.clipping.PipelineRunResult =
        runCatching {
    ...
    private fun saveStepTraces(
        runId: String,
        stepTraces: List<com.clipping.mcpserver.service.dto.clipping.PipelineStepTrace>
    ) {
    ...
    private fun updateRunAsSucceeded(
        runId: String,
        result: com.clipping.mcpserver.service.dto.clipping.PipelineRunResult
    ) {
